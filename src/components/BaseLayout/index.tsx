...
export function BaseLayout() {
  ...
  const { getReminder, reminderData: collaboratorReminderData } = useCollaboratorReminder();
  const [firstTime, setFirstTime] = useState(true);
  const [collaboratorReminderChecked, setCollaboratorReminderChecked] = useState(false);
  const [collaboratorReminderShown, setCollaboratorReminderShown] = useState(false);
  ...
  useEffect(() => {
      if (collaboratorReminderData?.hasReminder && collaboratorReminderData.message && !collaboratorReminderShown) {
